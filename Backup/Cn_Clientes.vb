...
#Region "Clientes"
    ...
    Public Shared Function fn_Clientes_Servicios_Horarios(ByVal Id_Cliente As Integer, ByRef lsv As cp_Listview, ByVal Status As String, ByVal Traslado As String) As Boolean
        Dim cnn As SqlConnection = Crea_ConexionSTD()
    ...
    Public Shared Function fn_Clientes_Guardar(ByVal IdCliente As Integer, ByVal Clave_Cliente As String, ByVal Nombre_Fiscal As String, ByVal Calle_Fiscal As String, ByVal Numero_Fiscal As Integer, _
                                               ByVal NumeroInt_Fiscal As String, ByVal Colonia_Fiscal As String, ByVal CP_Fiscal As Integer, ByVal Zona_Fiscal As Integer, ByVal RFC As String, _
                                               ByVal Nombre_Comercial As String, ByVal Calle_Comercial As String, ByVal Numero_Comercial As Integer, ByVal NumeroInt_Comercial As String, ByVal Zona_Comercial As Integer, _
                                               ByVal Colonia_Comercial As String, ByVal CP_Comercial As Integer, ByVal Id_Giro As Integer, ByVal Id_Categoria As Integer, ByVal Clave_Radio As String, _
                                               ByVal Local_Foraneo As Char, ByVal Id_Padre As Integer, ByVal Latitud As Decimal, ByVal Longitud As Decimal, ByVal Id_Ciudad As Integer, _
                                               ByVal RequiereMaterial As String, ByVal MensajeAlerta As String, ByVal Tipo_Cliente As String, ByVal Fecha_InicioOperaciones As Date, ByVal EntreCalle_Fiscal1 As String, _
                                               ByVal EntreCalle_Fiscal2 As String, ByVal EntreCalle_Comercial1 As String, ByVal EntreCalle_Comercial2 As String, ByVal Nombre_Corto As String, _
                                               ByVal Clave_Facturacion As String, ByVal Cliente_Padre As Boolean, ByVal Utiliza_Caset As String) As Boolean
        Dim Cnn As SqlConnection = Crea_ConexionSTD()
        Dim Tr As SqlTransaction = crear_Trans(Cnn)
    ...
    Public Shared Function fn_ContactosEnlace_Crear(ByVal Id_Contacto As Integer, ByVal Id_Cliente As Integer, ByVal TipoContacto As Integer, ByVal Nombre As String, ByVal Departamento As String, ByVal Puesto As String, _
                                                    ByVal Fecha_Nacimiento As Date, ByVal EstadoCivil As Integer, ByVal Comentarios As String, ByVal Telefono_Oficina As String, ByVal Telefono_Casa As String, ByVal Telefono_Celular As String, _
                                                    ByVal Telefono_Otro As String, ByVal Fax As String, ByVal Mail As String, ByVal Afectar_Subclientes As Boolean, ByRef lsv As cp_Listview, ByVal rfc As String, ByVal calle As String, ByVal Entrecalle1 As String, _
                                              ByVal entrecalle2 As String, ByVal numeroExterior As String, ByVal numeroInterior As String, ByVal colonia As String, _
    ...
    Public Shared Function fn_Contactos_Crear(ByVal Id_Cliente As Integer, ByVal TipoContacto As Integer, ByVal Nombre As String, ByVal Departamento As String, _
                                              ByVal Puesto As String, ByVal Fecha_Nacimiento As Date, ByVal EstadoCivil As Integer, ByVal Comentarios As String, _
                                              ByVal Telefono_Oficina As String, ByVal Telefono_Casa As String, ByVal Telefono_Celular As String, _
                                              ByVal Telefono_Otro As String, ByVal Fax As String, ByVal Mail As String, _
                                              ByVal Afectar_Subclientes As Boolean, ByRef lsv As cp_Listview, ByVal rfc As String, ByVal calle As String, ByVal Entrecalle1 As String, _
                                              ByVal entrecalle2 As String, ByVal numeroExterior As String, ByVal numeroInterior As String, ByVal colonia As String, _
                                              ByVal IdCiudad As Integer, ByVal IdEstado As Integer) As Boolean
        Dim cnn As SqlConnection = Crea_ConexionSTD()
        Dim tran As SqlTransaction = crear_Trans(cnn)
    ...
    Public Shared Function fn_Contactos_Actualizar(ByVal Id_Contacto As Integer, ByVal TipoContacto As Integer, ByVal Nombre As String, _
                                              ByVal Departamento As String, ByVal Puesto As String, ByVal Fecha_Nacimiento As Date, _
                                              ByVal EstadoCivil As Integer, ByVal Comentarios As String, ByVal Telefono_Oficina As String, ByVal Telefono_Casa As String, _
                                              ByVal Telefono_Celular As String, ByVal Telefono_Otro As String, ByVal Fax As String, ByVal Mail As String, ByVal rfc As String, ByVal calle As String, ByVal Entrecalle1 As String, _
                                              ByVal entrecalle2 As String, ByVal numeroExterior As String, ByVal numeroInterior As String, ByVal colonia As String, _
                                              ByVal IdCiudad As Integer, ByVal IdEstado As Integer) As Boolean
        Dim cnn As SqlConnection = Crea_ConexionSTD()
    ...
    Public Shared Function fn_Admin_Actualizar(ByVal IdCliente As Integer, ByVal ClienteF As Integer, ByVal clienteC As Integer, _
                                               ByVal EjecutivoC As Integer, ByVal Retiene As Char, ByVal Agrupa As Char, ByVal Descuento As Char, ByVal TipoD As Char, _
                                               ByVal CanitdadD As Decimal, ByVal ComparteF As Char, ByVal TipoC As Char, ByVal CantidadC As Decimal, _
    ...
    Public Shared Function fn_Servicios_Crear(ByVal Id_Cliente As Integer, ByVal Fecha_Inicio As Date, ByVal Comentarios As String, ByVal Id_Precio As Integer, ByVal Id_CR As Integer, _
                                              ByVal Id_EE As Integer, ByVal Id_KM As Integer, ByVal Cobro_Unico As Char, ByVal Tv_Predeterminado As Char, ByVal Recoleccion As Char, _
                                              ByVal Entrega_Dotaciones As Char, ByVal Cantidad_Kilometros As Integer, ByVal Id_PrecioDescripcion As Integer, _
                                              ByVal Afectar_Subclientes As Boolean, ByVal lsv As cp_Listview, Optional ByVal Id_Concepto As Integer = 0, Optional ByVal Id_Material As Integer = 0) As Boolean
    ...
    Public Shared Function fn_Servicios_Actualizar(ByVal Id_CS As Integer, ByVal Fecha_Inicio As Date, ByVal Comentarios As String, ByVal Id_Precio As Integer, _
                                                   ByVal Id_CR As Integer, ByVal Id_EE As Integer, ByVal Id_KM As Integer, ByVal Cobro_Unico As Char, _
                                                   ByVal Tv_Predeterminado As Char, ByVal Recoleccion As Char, ByVal Entrega_Dotaciones As Char, _
                                                   ByVal Cantidad_Kilometros As Integer, ByVal Id_PrecioDescripcion As Integer, ByVal Afectar_Subclientes As Boolean, _
                                                   ByVal lsv As cp_Listview, Optional ByVal Id_Concepto As Integer = 0, Optional ByVal Id_Material As Integer = 0) As Boolean
        Dim cnn As SqlConnection = Crea_ConexionSTD()
        Dim tran As SqlTransaction = crear_Trans(cnn)
        Dim cmd As SqlCommand
    ...
    Public Shared Function fn_Horarios_Crear(ByVal Id_CS As Integer, ByVal Fecha_Inicio As Date, ByVal Tipo_Frecuencia As Char, ByVal Frecuencia As Char, ByVal Cliente_Origen As Integer, _
                                             ByVal H_Recoleccion As String, ByVal Cliente_Destino As Integer, ByVal H_Entrega As String, ByVal Id_Ruta As Integer, _
                                             ByVal Escala_Boveda As Char, ByVal Mismo_Dia As Char, ByVal Dia_Entrega As Char, ByVal Id_RutaE As Integer, ByVal Cobrar_RE As String, _
                                             ByVal Cargo_ODC As Char, ByVal UnicaVez As String, ByVal Id_CH As Integer, ByVal Tipo As Integer, ByVal Prioridad As Integer, _
                                             ByVal Dt_SubClientes As DataTable) As Boolean
        Dim cnn As SqlConnection = Crea_ConexionSTD()
        Dim tr As SqlTransaction = crear_Trans(cnn)
        Try
    ...
    ''' <param name="Dia_Entrega">Es el numero de dia que se realiza la entrega dependiendo de la casilla anterior</param>
    ''' <param name="Id_RutaE">Es el id de la ruta de entrega</param>
    Public Shared Function fn_Horarios_Actualizar(ByVal Id As Integer, ByVal Fecha_Inicio As Date, ByVal Tipo_Frecuencia As Char, ByVal Frecuencia As Char, _
                                                  ByVal Cliente_Origen As Integer, ByVal H_Recoleccion As String, ByVal Cliente_Destino As Integer, _
                                                  ByVal H_Entrega As String, ByVal Id_Ruta As Integer, ByVal Escala_Boveda As Char, ByVal Mismo_Dia As Char, _
                                                  ByVal Dia_Entrega As Char, ByVal Id_RutaE As Integer, ByVal Tipo As Integer, ByVal Dt_Subclientes As DataTable, _
                                                  ByVal FrecuenciaAnterior As Char) As Boolean
        Try
            Dim cnn As SqlConnection = Crea_ConexionSTD()
    ...
    Public Shared Function fn_Horarios_CrearVarios(ByVal Fecha_Inicio As Date, ByVal Cliente As Integer, ByVal Origen As Boolean, _
                                                   ByVal Tipo_Frecuencia As Char, ByVal Cobrar_RE As String, ByVal Cargo_ODC As Char, _
                                                   ByVal UnicaVez As String, ByVal Dt_Datos As DataTable, _
...
#End Region
    ...
    Public Shared Function fn_Clientes_Crear(ByVal Nombre_Fiscal As String, ByVal Calle_Fiscal As String, ByVal Numero_Fiscal As String, ByVal NumeroInt_Fiscal As String, _
                                             ByVal Colonia_Fiscal As String, ByVal CP_Fiscal As String, ByVal Zona_Fiscal As String, ByVal RFC As String, ByVal Nombre_Comercial As String, _
                                             ByVal Calle_Comercial As String, ByVal Numero_Comercial As String, ByVal NumeroInt_Comercial As String, ByVal Zona_Comercial As String, _
                                             ByVal Colonia_Comercial As String, ByVal CP_Comercial As String, ByVal Id_Giro As Integer, ByVal Id_Categoria As Integer, ByVal Clave_Radio As String, _
                                             ByVal Local_Foraneo As Char, ByVal Id_Padre As Integer, ByVal Latitud As Decimal, ByVal Longitud As Decimal, ByVal RequiereMaterial As String, _
                                             ByVal MensajeAlerta As String, ByVal Tipo_Cliente As String, ByVal Fecha_InicioOperaciones As Date, ByVal EntreCalle_Fiscal1 As String, ByVal EntreCalle_Fiscal2 As String, _
                                             ByVal EntreCalle_Comercial1 As String, ByVal EntreCalle_Comercial2 As String, ByVal Nombre_Corto As String, ByVal Cliente_Padre As Boolean) As Integer
        Dim cmd As SqlCommand
        Dim Id As Integer
        Try
...
#Region "Clientes Proceso"
    ...
    Public Shared Function fn_ClientesProceso_Crear(ByVal Id_Cliente As Integer, ByVal Id_Cia As Integer, ByVal Clave_Cliente As String, _
                                                    ByVal Nombre_Comercial As String, ByVal Direccion_Comercial As String, ByVal Id_Ciudad As Integer, _
                                                    ByVal Id_CajaBancaria As Integer, ByVal Id_Grupo As Integer, ByVal Numero_Contrato As String, _
                                                    ByVal Requiere_Cuenta As Char, ByVal GrupoDepo As Integer, ByVal GrupoDota As Integer, ByVal Tipo_Proceso As String) As Integer
    ...
    Public Shared Function fn_ClientesProceso_CrearVarios(ByVal Dt_Clientes As DataTable, ByVal Id_Cia As Integer, ByVal Direccion_Comercial As String, ByVal Id_Ciudad As Integer, _
                                                          ByVal Id_CajaBancaria As Integer, ByVal Id_Grupo As Integer, ByVal Numero_Contrato As String, _
                                                          ByVal Requiere_Cuenta As Char, ByVal GrupoDepo As Integer, ByVal GrupoDota As Integer, ByVal Tipo_Proceso As String) As Integer
    ...
    ''' <param name="Numero_Contrato">Es el numero del contrato</param>
    ''' <param name="Requiere_Cuenta">Es un campo S / N que indica si el cliente tiene cuentas</param>
    Public Shared Function fn_ClientesProceso_Modificar(ByVal Id_ClienteP As Integer, ByVal Nombre_Comercial As String, ByVal Direccion_Comercial As String, ByVal Id_Ciudad As Integer, _
                                                    ByVal Id_Grupo As Integer, ByVal Numero_Contrato As String, ByVal Requiere_Cuenta As Char, ByVal GrupoDepo As Integer, ByVal GrupoDota As Integer, ByVal Tipo_Proceso As String) As Boolean
...
#Region "CajasFuertes"
    ...
    Public Shared Function fn_CajasFuertes_Nuevo(ByVal Id_CajaFuerteT As String, ByVal Marca As String, ByVal Serie As String, ByVal Id_Proveedor As Integer, _
                                                 ByVal Fecha_Compra As Date, ByVal Fecha_Fabricacion As Date, ByVal Combinacion As String, ByVal Observaciones As String, _
                                                 ByVal Nueva As String, ByVal TipoCaja As Integer, ByVal Status As String, ByVal Id_Cliente As Integer) As Boolean
        'Aqui se inserta un nuevo elemento 
        Dim Cnn As SqlClient.SqlConnection = Cn_Datos.Crea_ConexionSTD
    ...
    Public Shared Function fn_CajasFuertes_LogCombinaciones(ByVal Id As String, ByVal Log As String)
        ...
        End Try
    End Function
    Public Shared Function fn_CajasFuertes_Actualizar(ByVal Id As String, ByVal Id_CajaFuerteT As String, ByVal Marca As String, ByVal Serie As String, ByVal Id_Proveedor As Integer, ByVal Fecha_Compra As Date, _
                                                      ByVal Fecha_Fabricacion As Date, ByVal Combinacion As String, ByVal Observaciones As String, ByVal Nueva As String, ByVal CombinacionCliente As String, _
                                                      ByVal Fin_Renta As Date, ByVal Renta As Boolean, ByVal Id_Cliente As Integer) As Boolean
        'Aqui se actualiza un elemento
        Dim Cnn As SqlClient.SqlConnection = Cn_Datos.Crea_ConexionSTD
    ...
    Public Shared Function fn_CajasFuertesT_Nuevo(ByVal Clave_CajaFuerteT As String, ByVal AltoE As Integer, ByVal AnchoE As Integer, ByVal FondoE As Integer, _
                                                  ByVal AltoI As Integer, ByVal AnchoI As Integer, ByVal FondoI As Integer, ByVal StockMinimo As Integer, _
    ...
    Public Shared Function fn_CajasFuertesMov_Nuevo(ByVal Id_CajaFuerte As Integer, ByVal Fecha As Date, ByVal Tipo_Mov As Integer, ByVal Id_Cliente As Integer, ByVal Observaciones As String, _
                                                    ByVal Instalacion As String, ByVal ManejoCombinacion As String, ByVal Id_Contacto As Integer, ByVal Cita As Boolean, ByVal FechaCita As Date, _
                                                    ByVal HoraCita As String, ByVal FinRentaNull As Boolean, ByVal Fin_Renta As Date, ByVal NumeroCombinacion As String, ByVal Id_CS_Motivo As Integer, _
    ...
    Public Shared Function fn_CajasFuertesMov_Actualizar(ByVal Id_CajaFuerteMov As Integer, ByVal Fecha As Date, ByVal Tipo_Mov As Integer, ByVal Id_Cliente As Integer, ByVal Observaciones As String, _
                                                         ByVal Instalacion As String, ByVal ManejoCombinacion As String, ByVal Id_Contacto As Integer, ByVal Cita As Boolean, ByVal FechaCita As Date, _
                                                         ByVal HoraCita As String, ByVal FinRentaNull As Boolean, ByVal Fin_Renta As Date, ByVal NumeroCombinacion As String, ByVal Id_CS_Motivo As Integer, _
    ...
    Public Shared Function fn_CajasFuertesMov_Baja(ByVal Id_CajaFuerteMov As Integer, ByVal TipoMov As String, ByVal Id_CajaFuerte As Integer) As Boolean
        Dim Cnn As SqlClient.SqlConnection = Cn_Datos.Crea_ConexionSTD
        Dim Trans As SqlClient.SqlTransaction = Cn_Datos.crear_Trans(Cnn)
        Dim Cmd As SqlClient.SqlCommand
        Try
    ...
    Public Shared Function fn_CajasFuertesValidar_Status(ByVal Id_CajaFuerteMov As Integer, ByVal Observaciones_Valida As String, ByVal Combinacion As String, ByVal Fecha_Real As Date, ByVal Hora_Real As String) As Boolean
        ...
        Try
            ...
            If Dt_CajasFuertesMov IsNot Nothing AndAlso Dt_CajasFuertesMov.Rows.Count > 0 Then
                ...
                If Dt_CajasFuertesMov(0)("Tipo_Mov") = 1 OrElse Dt_CajasFuertesMov(0)("Tipo_Mov") = 2 OrElse _
...
#Region "Caja Fuerte - Acta de Inspección"
    ...
    Public Shared Function fn_ActaInspeccion_Create(ByVal FechaVisita As Date, ByVal HoraVisita As String, ByVal Id_Cliente As Integer, ByVal NombreComercial As String, _
...
#Region "Validar Acta de Inspección de Caja Fuerte"
    ...
    Public Shared Function fn_ActaInspeccion_Validar(ByVal Id_Inspeccion As Integer, ByVal FechaVisita As Date, ByVal HoraVisita As String, ByVal PersonaRecibio As String, _
                                                    ByVal UbicacionSugerida As String, ByVal UbicacionSugeridaD As String, ByVal Ventajas As String, ByVal Desventajas As String, _
                                                    ByVal NotasAdicionales As String, ByVal Id_Empleado As Integer, ByVal Id_Departamento As Integer, ByVal Id_Puesto As Integer, _
                                                    ByVal Id_JefeSeguridad As Integer, ByVal ContactoCita As String, ByVal FechaCita As Date, ByVal HorasCita As String, _
    ...
    Public Shared Function fn_ActaInspeccion_Update(ByVal Id_Inspeccion As Integer, ByVal FechaVisita As Date, ByVal HoraVisita As String, ByVal PersonaRecibio As String, _
                                                    ByVal UbicacionSugerida As String, ByVal UbicacionSugeridaD As String, ByVal Ventajas As String, ByVal Desventajas As String, _
                                                    ByVal NotasAdicionales As String, ByVal Id_Empleado As Integer, ByVal Id_Departamento As Integer, ByVal Id_Puesto As Integer, _
                                                    ByVal Id_JefeSeguridad As Integer, ByVal ContactoCita As String, ByVal FechaCita As Date, ByVal HorasCita As String, _
...
#Region "Cuentas"
    ...
    Protected Shared Function fn_Cuentas_ActualizaCuenta(ByVal Id_Cuenta As Integer, ByVal Tra As SqlTransaction, ByVal Numero_Cuenta As String, ByVal Id_Moneda As Integer, _
                                                         ByVal Id_Ciudad As Integer, ByVal Modo_Captura As Integer, ByVal Referenciada As Char, ByVal Referencia_Fija As Char, _
    ...
    Public Shared Function fn_Cuentas_Modificar(ByVal Id_Cuentas As Integer, ByVal Numero_Cuenta As String, ByVal Id_Moneda As Integer, ByVal Id_Ciudad As Integer, _
                                                ByVal Modo_Captura As Integer, ByVal Referenciada As Char, ByVal Referencia_Fija As Char, ByVal Id_CajaBancaria As Integer, _
...
#Region "Capturar Destino"
    ...
    Public Shared Function fn_CapturarDestino_Guardar(ByVal Nombre_Comercial As String, ByVal Calle_Comercial As String, ByVal Numero_Comercial As Integer, ByVal NumeroInt_Comercial As String, _
...
#Region "Actualizar Razón Social de Clientes"
    ...
    Public Shared Function fn_Clientes_GuardarRS(ByVal Id_Cliente As Integer, ByVal Nombre_Fiscal As String, ByVal Calle_Fiscal As String, ByVal Numero_Fiscal As Integer, _
                                                 ByVal EntreCalle_Fiscal1 As String, ByVal EntreCalle_Fiscal2 As String, ByVal NumeroInt_Fiscal As String, ByVal Colonia_Fiscal As String, _
                                                 ByVal CP_Fiscal As Integer, ByVal Zona_Fiscal As Integer, ByVal RFC As String, ByVal Clave_Facturacion As String, _
...
#Region "Contratos"
    ...
    Public Shared Function fn_Contratos_Guardar(ByVal Numero_Contrato As Integer, ByVal Fecha_Contrato As Date, _
                                                ByVal Fecha_Inicio As Date, ByVal Fecha_Fin As Date, ByVal Id_Cliente As Integer, _
                                                ByVal Firma_Empresa As String, ByVal Puesto_Empresa As String, _
                                                ByVal Testigo_Empresa As String, ByVal Id_CiudadFirma As Integer, ByVal Firma_Cliente As String, _
                                                ByVal Puesto_Cliente As String, ByVal Testigo_Cliente As String, ByVal Observaciones As String, _
    ...
    Public Shared Function fn_Contratos_Modificar(ByVal Id_Contrato As Integer, ByVal Fecha_Contrato As Date, _
                                                ByVal Fecha_Inicio As Date, ByVal Fecha_Fin As Date, ByVal Id_Cliente As Integer, _
                                                ByVal Firma_Empresa As String, ByVal Puesto_Empresa As String, _
                                                ByVal Testigo_Empresa As String, ByVal Id_CiudadFirma As Integer, ByVal Firma_Cliente As String, _
                                                ByVal Puesto_Cliente As String, ByVal Testigo_Cliente As String, ByVal Observaciones As String, _
...
#Region "Reporte General de Horarios"
    ...
    Public Shared Function fn_Clientes_ReporteGeneralHorarios(ByVal lsv As cp_Listview, ByVal Id_Cliente As Integer, ByVal Origen As Integer, ByVal Destino As Integer, ByVal IncluirSubclientes As String) As Boolean
        Try
...
#Region "ALERTAS CLIENTES 01-Oct-15"
    ...
    Public Shared Function fn_ClientesAlertas_Guardar(ByVal Clave_Alerta As String, ByVal Id_Cliente As Integer, ByVal Alerta_Recoleccion As String, _
                                                      ByVal Alerta_Entrega As String, _
