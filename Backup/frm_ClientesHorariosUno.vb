...
#Region "Metodos Privados"
    ...
    Private Sub GuardarDia(ByVal Dia As Integer)
        ...
        If Temp = False Or (Temp = True And Id_CHTemp = 0 And Id_CH = 0) Then
            ...
            fn_Horarios_Crear(Id_CS, dtp_H_FechaInicio.Value, cmb_H_TipoF.SelectedValue, Dia.ToString, cmb_H_ClienteO.SelectedValue, _
                               cmb_H_DeO.Text & "/" & cmb_H_AO.Text, cmb_H_ClienteD.SelectedValue, cmb_H_DeD.Text & "/" & cmb_H_AD.Text, _
                              cmb_H_Ruta.SelectedValue, cmb_H_Boveda.SelectedValue, cmb_H_MismoDia.SelectedValue, DiaEntrega.ToString, _
                               cmb_H_RutaEntrega.SelectedValue, cmb_FacturarRE.SelectedValue, cmb_CargoA.SelectedValue, unicavez, Id_CH, _
                              Tipo, Prioridad, Dt_SubClientes)
        Else
            'Modificacion de un Horario Temp. Es un Update en Horarios Temp
            fn_Horarios_Actualizar(Id_CHTemp, dtp_H_FechaInicio.Value, cmb_H_TipoF.SelectedValue, Dia.ToString, cmb_H_ClienteO.SelectedValue, _
                                   cmb_H_DeO.Text & "/" & cmb_H_AO.Text, cmb_H_ClienteD.SelectedValue, cmb_H_DeD.Text & "/" & cmb_H_AD.Text, _
                                   cmb_H_Ruta.SelectedValue, cmb_H_Boveda.SelectedValue, cmb_H_MismoDia.SelectedValue, DiaEntrega.ToString, _
                                   cmb_H_RutaEntrega.SelectedValue, Tipo, Dt_SubClientes, FrecuencaAnt)
        End If
    End Sub
