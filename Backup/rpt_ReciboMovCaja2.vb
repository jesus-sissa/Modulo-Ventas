...
Public Class rpt_ReciboMovCaja2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.rpt_ReciboMovCaja2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ReciboMovCaja2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ReciboMovCaja2 = New rpt_ReciboMovCaja2
        rpt.Site = Me.Site
        Return rpt
    End Function
