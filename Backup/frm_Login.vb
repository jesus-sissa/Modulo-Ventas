...
Public Class frm_Login
    ...
    Private Sub frm_Login_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If (Application.ApplicationDeployment.IsNetworkDeployed) Then
            ...
            lbl_Modulo.Text = "Módulo Ventas v" & ModuloVersion
        Else
            lbl_Modulo.Text = "Módulo Ventas"
    ...
    Private Sub cmd_OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_OK.Click
        ContraHash = FormsAuthentication.HashPasswordForStoringInConfigFile(tbx_Clave.Text, "SHA1")
        Call Validar()
    End Sub
    ...
    Sub Validar()
        ...
        Try
            ...
            If dt_ParametrosGlobales Is Nothing Then
                MsgBox("Ocurrió un error al consultar Parámetros Globales.", MsgBoxStyle.Critical, frm_MENU.Text)
                Exit Sub
            End If

            If dt_ParametrosGlobales.Rows.Count = 0 Then
                MsgBox("No existen Parámetros Globales para cargar.", MsgBoxStyle.Critical, frm_MENU.Text)
                Exit Sub
            Else
            ...
            Else
                ...
                If UsuarioTipo = 1 Or UsuarioTipo = 3 Then
                    If Not Cn_Login.Usuarios_Horas(UsuarioId) Then
                        MsgBox("Usuario: " & UsuarioN & " No tiene Privilegios para entrar en este Dia y Hora.", 16 + 0, frm_MENU.Text)
                        Exit Sub
                    End If
                    Call MenuS()
        ...
        frm_MENU.Show()
    End Sub
    Sub Combinaciones(ByVal dt_acceso As DataTable)
        If dt_acceso IsNot Nothing Then
            For Each dr As DataRow In dt_acceso.Rows
                If dr("Descripcion").ToString() = "CAMBIAR COMBINACIONES" Then
                    Acceso = True
                End If
            Next       
        End If
