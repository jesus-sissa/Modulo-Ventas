...
Public Class rpt_ReciboMovCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.rpt_ReciboMovCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ReciboMovCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ReciboMovCaja = New rpt_ReciboMovCaja
        rpt.Site = Me.Site
        Return rpt
    End Function
