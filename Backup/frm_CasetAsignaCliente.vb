...
Public Class frm_CasetAsignaCliente
    ...
    Private Sub CargarCasetAsignados()
    End Sub
    ...
    Private Sub lsv_CasetDisponibles_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lsv_CasetDisponibles.SelectedIndexChanged
    ...
    Private Sub btn_Retirar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Retirar.Click
        ...
        If Not fn_Kardex_CasetAsignaCliente_Cancelar(lsv_CasetAsignados.SelectedItems(0).Tag, lsv_CasetAsignados.SelectedItems(0).SubItems(6).Text, tbx_Observaciones.Text) Then
    ...
    Private Sub tbx_Observaciones_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles tbx_Observaciones.KeyPress
        e.KeyChar = UCase(e.KeyChar)
    End Sub

    Private Sub lsv_CasetAsignados_ItemChecked(ByVal sender As Object, ByVal e As System.Windows.Forms.ItemCheckedEventArgs) Handles lsv_CasetAsignados.ItemChecked
