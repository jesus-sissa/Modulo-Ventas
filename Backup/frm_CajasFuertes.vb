...
#Region "Botones y ComboBox"
    ...
    Private Sub btn_Guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Guardar.Click
        ...
        If Tab_Nuevo.Text = "Nuevo" Then
            ...
            If Cn_Clientes.fn_CajasFuertes_Nuevo(cmb_CajaFuerteT.SelectedValue, tbx_Marca.Text, tbx_Serie.Text, cmb_Proveedor.SelectedValue, dtp_Compra.Value.Date, _
                                                 dtp_Fabricacion.Value.Date, Combinacion, rtb_Observaciones.Text, IIf(cmb_Nueva.SelectedValue = "0", "", cmb_Nueva.SelectedValue), _
                                                 TipoCaja, Status, cmb_ClienteAsignado.SelectedValue) Then
        ...
        Else
            ...
            If Cn_Clientes.fn_CajasFuertes_Actualizar(tbx_ClaveCajaFuerte.Tag, cmb_CajaFuerteT.SelectedValue, tbx_Marca.Text, tbx_Serie.Text, _
                                                      cmb_Proveedor.SelectedValue, dtp_Compra.Value.Date, dtp_Fabricacion.Value.Date, Combinacion, _
                                                      rtb_Observaciones.Text, IIf(cmb_Nueva.SelectedValue = "0", "", cmb_Nueva.SelectedValue), CombinacionCliente, dtp_FechaRetiro.Value.Date, _
                                                      dtp_FechaRetiro.Enabled, cmb_ClienteAsignado.SelectedValue) Then
