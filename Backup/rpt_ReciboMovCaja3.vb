...
Public Class rpt_ReciboMovCaja3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.rpt_ReciboMovCaja3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ReciboMovCaja3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ReciboMovCaja3 = New rpt_ReciboMovCaja3
        rpt.Site = Me.Site
        Return rpt
    End Function
