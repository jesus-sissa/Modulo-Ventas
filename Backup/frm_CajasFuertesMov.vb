...
#Region "Sub"
    ...
    Private Function Guardar() As Boolean
        ...
        If Not rbn_Venta.Checked And Not rbn_Renta.Checked And Not rbn_Retiro.Checked And Not rbn_ManejoCombinacion.Checked And Not rbn_Reubicacion.Checked And Not rbn_Combinacion.Checked And Not rbn_Mantenimiento.Checked Then
        ...
        If gbx_Instalacion.Enabled Then
            If Not rbn_Ambos.Checked AndAlso Not rbn_Instalacion.Checked AndAlso Not rbn_Desinstalacion.Checked AndAlso Not rbn_Ninguno.Checked Then
    ...
    Private Function Guardar_MantenimientoInterno() As Boolean
        If StatusMov = "A" Then
            ...
            If fn_CajasFuertesMov_Nuevo(Id_CajaFuerte, dtp_Fecha.Value.Date, 9, 0, rtb_Observaciones.Text, "N", ManejoCombinacion, 0, gbx_Cita.Enabled, dtp_FechaCita.Value.Date, _
        ...
        Else
            ...
            If fn_CajasFuertesMov_Actualizar(Id_CajaFuerteMov, dtp_Fecha.Value.Date, 9, 0, rtb_Observaciones.Text, "N", ManejoCombinacion, 0, _
                                             gbx_Cita.Enabled, dtp_FechaCita.Value.Date, dtp_HoraCita.Value.TimeOfDay.ToString, chk_Retiro.Checked, _
