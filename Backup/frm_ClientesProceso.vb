    ...
    Private Sub btn_Guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Guardar.Click
        ...
        If tab_Nuevo.Tag = 0 Then
            If cmb_Cliente.Visible Then
                ...
                tab_Nuevo.Tag = fn_ClientesProceso_CrearVarios(Dt_Clientes, cmb_Compañias.SelectedValue, tbx_1_Direccion.Text, cmb_Ciudad.SelectedValue, _
                                                               cmb_CajaBancariaNew.SelectedValue, cmb_GrupoF.SelectedValue, tbx_1_Contrato.Text, cmb_RequiereCuentas.Text, _
                                                               cmb_GrupoDeposito.SelectedValue, cmb_GrupoDota.SelectedValue, cmb_TipoProceso.SelectedValue)
            Else

                tab_Nuevo.Tag = fn_ClientesProceso_Crear(Id_Cliente, cmb_Compañias.SelectedValue, tbx_1_Cliente.Text, NombreComercial, tbx_1_Direccion.Text, cmb_Ciudad.SelectedValue, _
                                                         cmb_CajaBancariaNew.SelectedValue, cmb_GrupoF.SelectedValue, tbx_1_Contrato.Text, cmb_RequiereCuentas.Text, cmb_GrupoDeposito.SelectedValue, _
                                                         cmb_GrupoDota.SelectedValue, cmb_TipoProceso.SelectedValue)
            End If
            ...
            End If
        Else
            If Not fn_ClientesProceso_Modificar(tab_Nuevo.Tag, NombreComercial, tbx_1_Direccion.Text, cmb_Ciudad.SelectedValue, _
                                     cmb_GrupoF.SelectedValue, tbx_1_Contrato.Text, cmb_RequiereCuentas.Text, cmb_GrupoDeposito.SelectedValue, cmb_GrupoDota.SelectedValue, cmb_TipoProceso.SelectedValue) Then
