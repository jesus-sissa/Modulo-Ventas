...
Public Class frm_CajasFuertesT
    ...
    Private Sub frm_CajasFuertesT_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Cp_cmb_TipoReceptor.Actualizar()
        Cp_cmb_TipoChapa.Actualizar()
        Cp_cmb_TipoDial.Actualizar()
...
#Region "Sub"
    ...
    Private Function Validar() As Boolean
        If Cp_cmb_TipoReceptor.SelectedValue = 0 Then
            MsgBox("Seleccione Tipo de Receptor.", MsgBoxStyle.Critical, frm_MENU.Text)
            Cp_cmb_TipoReceptor.Focus()
            Return True
        End If

        If Cp_cmb_TipoDial.SelectedValue = 0 Then
            MsgBox("Seleccione Tipo de Dial.", MsgBoxStyle.Critical, frm_MENU.Text)
            Cp_cmb_TipoDial.Focus()
            Return True
        End If

        If Cp_cmb_TipoChapa.SelectedValue = 0 Then
            MsgBox("Seleccione Tipo de Chapa.", MsgBoxStyle.Critical, frm_MENU.Text)
            Cp_cmb_TipoChapa.Focus()
            Return True
        End If
