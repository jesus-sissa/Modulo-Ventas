...
Public Class Cn_Datos
    ...
    Public Shared Function Crea_Parametro(ByRef cm As SqlCommand, ByVal Nombre As String, ByVal Tipo As SqlDbType, ByVal Valor As Object, Optional ByVal Mayusculas As Boolean = False) As SqlParameter
