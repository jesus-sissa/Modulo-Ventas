...
#Region "Botones"
    ...
    Private Sub Btn_CancerlarMov_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_CancerlarMov.Click
        ...
        If Not fn_CajasFuertesMov_Baja(lsv_Catalogo.SelectedItems(0).Tag, lsv_Catalogo.SelectedItems(0).SubItems(6).Text, lsv_Catalogo.SelectedItems(0).SubItems(11).Text, lsv_Catalogo.SelectedItems(0).SubItems(13).Text) Then
