...
Public Class rpt_ServiciosOtros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.rpt_ServiciosOtros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ServiciosOtros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ServiciosOtros = New rpt_ServiciosOtros()
        rpt.Site = Me.Site
        Return rpt
    End Function
