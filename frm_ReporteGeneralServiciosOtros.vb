Public Class frm_ReporteGeneralServiciosOtros
    ...
    Private Sub btn_Mostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Mostrar.Click
        ...
        If Not Cn_Clientes.fn_Clientes_Servicios_Horarios(cmb_Cliente.SelectedValue, lsv_Servicio, cmb_Status.SelectedValue, "N", IncluirSubclientes) Then
            MsgBox("Ocurrió un error al ejecutar la consulta.", MsgBoxStyle.Critical, frm_MENU.Text)
        End If
        lsv_Servicio.Columns(17).Width = 120
        lsv_Servicio.Columns(23).Width = 120
        lsv_Servicio.Columns(24).Width = 400
    ...
    Private Sub btn_Exportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Exportar.Click
        ...
        FuncionesGlobales.fn_Exportar_Excel(lsv_Servicio, 2, "REPORTE GENERAL DE SERVICIOS OTROS (AL " & DateTime.Now.Date.ToShortDateString & ")", 0, 0, frm_MENU.prg_Barra)
