...
Public Class frm_Clientes
    ...
    Dim Mail As String
    Dim Id_ClienteGrupoD As Integer = 0
...
#Region "Eventos del Formulario"
    ...
    Private Sub frm_Clientes_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        cmb_EsExtraodinario.AgregarItem("S", "SI")
        cmb_EsExtraodinario.AgregarItem("N", "NO")
        ...
        Select Case tab_Clientes.SelectedTab.Name
            Case tab_Generales.Name
                ...
                If tbx_KM_CFDI.Text.Trim() = "" Then
                    MsgBox("Favor de ingresar el KM CFDI", MsgBoxStyle.Critical, frm_MENU.Text)
                    Exit Sub
                End If
                If tbx_Categoria.Text.Trim() = "" Then
                    MsgBox("Favor de ingresar la Categoria", MsgBoxStyle.Critical, frm_MENU.Text)
                    tbx_Categoria.Focus()
                    Exit Sub
                End If
                If tbx_UsarUUID.Text.Trim() = "" Then
                    MsgBox("Favor de ingresar Usar UUID", MsgBoxStyle.Critical, frm_MENU.Text)
                    Exit Sub
                End If

                If tbx_UsaCFDI.Text.Trim() = "" Then
                    MsgBox("Favor de ingresar Usa CFDI", MsgBoxStyle.Critical, frm_MENU.Text)
                    Exit Sub
                End If
                ...
                If tbx_UsaCFDI.Text.Trim = "" Then
                    MsgBox("Favor de indicar el Uso de CFDI", MsgBoxStyle.Critical, frm_MENU.Text)
                    tbx_UsaCFDI.Focus()
                    Exit Sub
                End If

                If tbx_COMPAQ_Codigo.Text.Trim = "" Then
                    MsgBox("Favor de indicar el Codigo CONTPAQ", MsgBoxStyle.Critical, frm_MENU.Text)
                    tbx_COMPAQ_Codigo.Focus()
                    Exit Sub
                End If

                If tbx_CONTPAQ_Direccion_Cliente.Text.Trim = "" Then
                    MsgBox("Favor de introducir la Dirccion Contpaq del Cliente.", MsgBoxStyle.Critical, frm_MENU.Text)
                    tbx_CONTPAQ_Direccion_Cliente.Focus()
                    Exit Sub
                End If
                ...
                Dim UtilizaRemision As String

                'en caso de que no seleccione ninguna por defecto se pondra como moral
                If cmb_Regimen.Text = "Seleccione..." Then
                    cmb_Regimen.Text = "Moral"
                End If
                ...
                If rdb_CasetSI.Checked Then
                    If Not rdb_CasetPropioSI.Checked And Not rdb_CasetPropioNO.Checked Then
                        MsgBox("Indica si el caset es del cliente", MsgBoxStyle.Critical, frm_MENU.Text)
                        Exit Sub
                    End If
                End If
                ...
                If rdb_RemisionSI.Checked Then UtilizaRemision = "S" Else UtilizaRemision = "N"
                '.-------------------------------------------------..MODIFICACION POR MORA 04/12/2022 -----------------------
                ...
                If fn_Clientes_Guardar(Id_Cliente, tbx_Buscar.Text, tbx_NombreF.Text, tbx_CalleF.Text,
                                       CInt(tbx_NumeroF.Text), tbx_IntF.Text, cmb_ColoniaF.Text, 'tbx_ColoniaF.Text,
                                       CInt(tbx_CPF.Text), cmb_ZonaF.SelectedValue,
                                       tbx_RFC.Text, tbx_NombreC.Text, tbx_CalleC.Text,
                                       CInt(tbx_NumeroC.Text), tbx_IntC.Text,
                                       cmb_ZonaC.SelectedValue, cmb_ColoniaC.Text,'tbx_ColoniaC.Text,
                                       CInt(tbx_CPC.Text),
                                       cmb_Giro.SelectedValue,
                                       cmb_Categoria.SelectedValue,
                                       tbx_ClaveRadio.Text, Foraneo,
                                       cmb_SeleccioneCP.SelectedValue, tbx_Latitud.Text, tbx_Longitud.Text,
                                       cmb_CiudadC.SelectedValue, RequiereMaterial,
                                       rtb_MensajeAlerta.Tag, Tipo_Cliente, dtp_InicioOp.Value.Date,
                                       tbx_EntreF1.Text, tbx_EntreF2.Text, tbx_EntreC1.Text,
                                       tbx_EntreC2.Text, tbx_NombreCorto.Text,
                                       tbx_ClaveFacturacion.Text.Trim,
                                       chk_ClienteP.Checked, UtilizaCaset,
                                       EsCasetDelCliente, UtilizaCatalogoDigital,
                                       cmb_CFDI.SelectedValue,
                                       tbx_COMPAQ_Codigo.Text,
                                       UtilizaRemision,
                                       tbx_KM_CFDI.Text,
                                       ...
                                       tbx_Categoria.Text,
                                       tbx_UsaCFDI.Text,
                                       tbx_AdendaNombre.Text,
                                       tbx_AdendaProveedor.Text,
                                       tbx_AdendaPedido.Text,
                                       tbx_CONTPAQ_Direccion_Cliente.Text,
                                       cmb_Regimen.Text, Envia_Correo, tbx_Correo.Text, cmb_Grupos.SelectedValue, Id_ClienteGrupoD) Then
            ...
            Case tab_Administrativos.Name
                ...
                If fn_Admin_Actualizar(Id_Cliente, cmb_ClienteF.SelectedValue, cmb_ClienteC.SelectedValue, cmb_Ejecutivo.SelectedValue,
                                        cmb_Retiene.SelectedValue, cmb_Agrupa.SelectedValue, cmb_Descuento.SelectedValue,
                                       cmb_TipoDesc.SelectedValue, tbx_CantidadD.Text, "N", cmb_TipoDesc.SelectedValue,
...
#Region "Funciones de todo el formulario"
    ...
    Public Sub LlenarTodasPestañas()
        ...
        Call Observaciones_Llenar()
        Call ValidarCodigoPostalesMostrar()
...
#Region "Datos Generales"
    ...
    Private Sub DatosGenerales_Llenar()
        ...
        tbx_COMPAQ_Codigo.Text = Dr_DatosGenerales("COMPAQ_Codigo")
        ...
        tbx_Correo.Text = Dr_DatosGenerales("Correo")

        'Se obtiene los datos del país, estado, ciudad y zona para fiscal smc
        If Dr_DatosGenerales("Zona_Fiscal") > 0 Then
            ...
            If Dr_Lugar IsNot Nothing Then
                ...
                Try
                    ...
                    'cmb_ColoniaF.SelectedValue = 1 'Dr_Lugar("Id_Zona")
                Catch ex As Exception
                    MsgBox("El cliente tiene problemas con su dirreccion. Favor de revisar.", MsgBoxStyle.Critical, frm_MENU.Text)
                End Try
        ...
        If Dr_DatosGenerales("KM_CFDI") = 0 Then tbx_KM_CFDI.Text = "" Else tbx_KM_CFDI.Text = Dr_DatosGenerales("KM_CFDI")
        If Dr_DatosGenerales("ComprobanteUUID") = "" Then tbx_ComprobanteUUID.Text = "" Else tbx_ComprobanteUUID.Text = Dr_DatosGenerales("ComprobanteUUID")
        If Dr_DatosGenerales("UsarUUID") = 0 Then tbx_UsarUUID.Text = "" Else tbx_UsarUUID.Text = Dr_DatosGenerales("UsarUUID")
        If Dr_DatosGenerales("Categoria") = "" Then tbx_Categoria.Text = "" Else tbx_Categoria.Text = Dr_DatosGenerales("Categoria")
        ...
        cmb_CFDI.SelectedValue = Dr_DatosGenerales("Id_CFDI")
        ...
        If Dr_DatosGenerales("Envia_Correo") = "SI" Then rdb_EnviarCorreoSI.Checked = True Else rdb_EnviarCorreoNo.Checked = True

        If Dr_DatosGenerales("Caset_Propio") = "SI" Then rdb_CasetPropioSI.Checked = True Else rdb_CasetPropioNO.Checked = True

        If Dr_DatosGenerales("Utiliza_Caset") = "SI" Then rdb_CasetSI.Checked = True Else rdb_CasetNO.Checked = True

        If Dr_DatosGenerales("Utiliza_CatalogoDigital") = "SI" Then rbn_UtilizaCatalogoDigitalSI.Checked = True Else rbn_UtilizaCatalogoDigitalNO.Checked = True

        If Dr_DatosGenerales("Utiliza_Remision") = "SI" Then rdb_RemisionSI.Checked = True Else rdb_RemisionNO.Checked = True

        Select Case Dr_DatosGenerales("Estado")
            Case "1"
                tbx_CONTPAQ_Direccion_Cliente.Text = "M-" + tbx_Buscar.Text
            Case "3"
                tbx_CONTPAQ_Direccion_Cliente.Text = "S-" + tbx_Buscar.Text
        End Select
        ...
        cmb_ColoniaC.Text = Dr_DatosGenerales("Colonia_Comercial")
        cmb_ColoniaF.Text = Dr_DatosGenerales("Colonia_Fiscal")
        cmb_Regimen.Text = Dr_DatosGenerales("Regimen")
        tbx_UsaCFDI.Text = Dr_DatosGenerales("UsoCFDI")
        tbx_AdendaNombre.Text = Dr_DatosGenerales("Adenda_Nombre")
        tbx_AdendaProveedor.Text = Dr_DatosGenerales("Adenda_Proveedor")
        tbx_AdendaPedido.Text = Dr_DatosGenerales("Adenda_Pedido")
        'cmb_Grupos.SelectedIndex = Dr_DatosGenerales("Id_ClienteGrupo")
        cmb_Grupos.SelectedValue = Dr_DatosGenerales("Id_ClienteGrupo")
        Id_ClienteGrupoD = Dr_DatosGenerales("Id_ClienteGrupoD")

        If Dr_DatosGenerales("CONTPAQ_Direccion_Cliente").ToString() <> "" Then
            tbx_CONTPAQ_Direccion_Cliente.Text = Dr_DatosGenerales("CONTPAQ_Direccion_Cliente")
        End If

        'Select Case Dr_DatosGenerales("Tipo_Proceso")
        '    Case "A"
        '        Cmb_tipoProceso.SelectedIndex = 0
        '    Case "B"
        '        Cmb_tipoProceso.SelectedIndex = 1
        '    Case "C"
        '        Cmb_tipoProceso.SelectedIndex = 2
        '    Case ""
        '        Cmb_tipoProceso.SelectedIndex = 3
        'End Select
        'If chk_ClienteP.Checked Then
    ...
    Private Sub DatosGenerales_Limpiar()
        cmb_SeleccioneCP.SelectedValue = "0"
        cmb_Grupos.SelectedValue = "0"
        chk_ClienteP.Checked = False

        tbx_Comentarios.Clear()

        tbx_COMPAQ_Codigo.Clear()
        ...
        rdb_EnviarCorreoSI.Checked = False
        rdb_EnviarCorreoNo.Checked = False
        ...
        tbx_AdendaNombre.Clear()
        tbx_AdendaPedido.Clear()
        tbx_AdendaProveedor.Clear()
        tbx_UsaCFDI.Clear()
        tbx_CONTPAQ_Direccion_Cliente.Clear()
        tbx_Correo.Clear()
    ...
    Private Sub btn_Reingresar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Reingresar.Click
        ...
        If Not chk_ClienteP.Checked AndAlso cmb_SeleccioneCP.SelectedValue = 0 Then
            MsgBox("Debe de Marcar si es Cliente Padre, sino seleccionar el Padre del Subcliente mostrado o" & Chr(13) &
        ...
        Else
            ...
            If dr_Cliente IsNot Nothing Then
                ...
                ElseIf rdb_Otro.Checked Then
                    Tipo_Cliente = "OTRO"
                ElseIf rdb_CajerosAut.Checked Then
                    Tipo_Cliente = "CAJERO AUTOMATICO"
                Else
...
#Region "Contactos"
    ...
    Private Sub btn_GuardarC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_GuardarC.Click
        ...
        If tbx_Nombre.Tag > 0 Then
            ...
            If Not fn_ContactosEnlace_Crear(tbx_Nombre.Tag, Id_Cliente, cmb_ContactoTipo.SelectedValue, tbx_Nombre.Text.Trim, tbx_Departamento.Text.Trim,
                                            tbx_Puesto.Text.Trim, dtp_FechaNacimiento.Text, cmb_EstadoCivil.SelectedValue, tbx_Comentarios.Text.Trim,
                                            tbx_TelOficina.Text.Trim, tbx_TelCasa.Text.Trim, tbx_TelCelular.Text.Trim, tbx_TelOtro.Text.Trim, tbx_Fax.Text.Trim, tbx_Mail.Text.Trim,
                                            chk_Contactos.Checked, lsv_SubClientes, tbx_rfcContacto.Text.Trim, tbx_calleContacto.Text.Trim, tbx_CalleEntre1.Text.Trim,
                                  tbx_calleEntre2.Text.Trim, tbx_NumExterior.Text.Trim, tbx_numInterior.Text.Trim, tbx_coloniaContacto.Text.Trim,
        ...
        ElseIf lsv_Contactos.SelectedItems.Count = 0 Then
            ...
            If Not fn_Contactos_Crear(Id_Cliente, cmb_ContactoTipo.SelectedValue, tbx_Nombre.Text.Trim, tbx_Departamento.Text.Trim,
                                  tbx_Puesto.Text, dtp_FechaNacimiento.Text, cmb_EstadoCivil.SelectedValue, tbx_Comentarios.Text.Trim,
                                  tbx_TelOficina.Text, tbx_TelCasa.Text, tbx_TelCelular.Text.Trim, tbx_TelOtro.Text.Trim, tbx_Fax.Text.Trim, tbx_Mail.Text.Trim,
                                  chk_Contactos.Checked, lsv_SubClientes, tbx_rfcContacto.Text.Trim, tbx_calleContacto.Text.Trim, tbx_CalleEntre1.Text.Trim,
                                  tbx_calleEntre2.Text.Trim, tbx_NumExterior.Text.Trim, tbx_numInterior.Text.Trim, tbx_coloniaContacto.Text.Trim,
                                 cmb_CiudadContactos.SelectedValue, cmb_estadoContactos.SelectedValue) Then
                MsgBox("Ocurrio un error al intentar guardar los contactos.", MsgBoxStyle.Critical, frm_MENU.Text)
        ...
        Else
            ...
            If Not fn_Contactos_Actualizar(lsv_Contactos.SelectedItems(0).SubItems(14).Text, cmb_ContactoTipo.SelectedValue, tbx_Nombre.Text.Trim, tbx_Departamento.Text.Trim,
                                           tbx_Puesto.Text.Trim, dtp_FechaNacimiento.Text, cmb_EstadoCivil.SelectedValue, tbx_Comentarios.Text.Trim,
                                           tbx_TelOficina.Text.Trim, tbx_TelCasa.Text.Trim, tbx_TelCelular.Text.Trim, tbx_TelOtro.Text.Trim, tbx_Fax.Text.Trim, tbx_Mail.Text.Trim, tbx_rfcContacto.Text.Trim, tbx_calleContacto.Text.Trim, tbx_CalleEntre1.Text.Trim,
                                  tbx_calleEntre2.Text.Trim, tbx_NumExterior.Text.Trim, tbx_numInterior.Text.Trim, tbx_coloniaContacto.Text.Trim,
                                 cmb_CiudadContactos.SelectedValue, cmb_estadoContactos.SelectedValue) Then
                MsgBox("Ocurrio un error al intentar guardar los contactos.", MsgBoxStyle.Critical, frm_MENU.Text)
                Exit Sub
...
#Region "Servicios Otros"
    ...
    Private Sub Btn_AgregarOtros_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_AgregarOtros.Click
        ...
        If ComprobarDatosContpaq() Then
            MsgBox("Debe de ingresar la Clave Cliente Contpaq y Contpaq Direccion Cliente", MsgBoxStyle.Critical, frm_MENU.Text)
            Exit Sub
        Else
        End If
        ...
        If lsv_ServiciosOtros.SelectedItems.Count = 0 Then
            If Not fn_Servicios_Crear(Id_Cliente, dtp_FechaInicioOtros.Value, tbx_ComentariosOtros.Text, cmb_PrecioOtros.SelectedValue, 0,
                                      0, 0, CobroUOtros, "N", "N", "N", 0, cmb_DescripcionOtros.SelectedValue, chk_ServiciosOtros.Checked,
                                      cmb_EsExtraodinario.SelectedValue,
            ...
            End If
        Else
            If Not fn_Servicios_Actualizar(lsv_ServiciosOtros.SelectedItems(0).Tag,
                                           dtp_FechaInicioOtros.Value, tbx_ComentariosOtros.Text,
                                           cmb_PrecioOtros.SelectedValue, 0, 0, 0, CobroUOtros, "N", "N", "N", 0,
                                           cmb_DescripcionOtros.SelectedValue,
                                           chk_ServiciosOtros.Checked,
                                           lsv_SubClientes,
                                            cmb_EsExtraodinario.SelectedValue,
                                           cmb_ConceptoProceso.SelectedValue,
                                           cmb_Materiales.SelectedValue) Then
            ...
            Else
                ...
                Dim DetalleHTML As String = "<html><style media='screen'>body{font-family: 'Lucida Console', 'Courier New', monospace;background-color:#d7d5d5;}</style><body><Table style=background-color: '#E3DFD9;' width='100%'><tr><td colspan='4' align='center'><b style='color: #D68910;'>Boletín Informativo</b></td>" _
                                    & "</tr> <tr><td colspan='4' align='center'><b style='color: #D68910;'>HISTORIAL DE ACTUALIZACION</b></td></tr>" _
                                    & "</tr> <tr><td colspan='4' align='center'><b style='color:  #000;'>DATOS NUEVOS</b></td></tr>" _
                                    & "<tr><td colspan='4' align='center'><label>Usuario:</label> " & UsuarioN & " </td>" _
                                    & "<tr><td colspan='4' align='center'><label>Id CS:</label> " & lsv_ServiciosOtros.SelectedItems(0).Tag & " </td>" _
                                    & "<tr><td colspan='4' align='center'><label>Fecha de inicio:</label> " & dtp_FechaInicioOtros.Value & " </td>" _
                                    & "<tr><td colspan='4' align='center'><label>Linea de servicio:</label> " & tbx_LineaOtros.Text & "  " & cmb_LineaOtros.Text & " </td>" _
                                    & "<tr><td colspan='4' align='center'><label>Precio:</label> " & tbx_ClvePrecioOtros.Text & "  " & cmb_PrecioOtros.Text & " </td>" _
                                    & "<tr><td colspan='4' align='center'><label>Material:</label> " & cmb_Materiales.Text & " </td>" _
                                     & "</tr><tr><td colspan='4' align='center'><label>Fecha Modificada:</label>  " & Now.Date.ToShortDateString & "  </td>" _
                                    & "</tr><tr><td colspan='4'><br><hr /></td>" _
                                    & "</tr> <tr><td colspan='4' align='center'><b style='color:  #000;'>DATOS ANTERIORES</b></td></tr>" _
                                    & "<tr><td colspan='4' align='center'><label>Fecha de inicio:</label> " & lsv_ServiciosOtros.SelectedItems(0).SubItems(0).Text & " </td>" _
                                    & "<tr><td colspan='4' align='center'><label>Linea de servicio:</label>" & lsv_ServiciosOtros.SelectedItems(0).SubItems(1).Text & " </td>" _
                                    & "<tr><td colspan='4' align='center'><label>Precio:</label> " & lsv_ServiciosOtros.SelectedItems(0).SubItems(2).Text & "  " & lsv_ServiciosOtros.SelectedItems(0).SubItems(3).Text & " </td>" _
                                    & "<tr><td colspan='4' align='center'><label>Material:</label> " & lsv_ServiciosOtros.SelectedItems(0).SubItems(4).Text & " </td>" _
                                    & "</tr><tr><td colspan='4'><br><hr /></td>" _
                                    & "<h2 style='color: #D68910; font-size: 20PX;' colspan='2' align='center'>Agente de Servicios SIAC 2022</h2></body></html>"

                ' Call ObtenerDestinos("Historial de Servicios Otros", DetalleHTML, "Alertas de Historial")
    ...
    Public Shared Function ObtenerDestinos(ByVal Detalles As String, ByVal DetalleHTML As String, ByVal Cabezera As String)
        If fn_AlertasGeneradas_Guardar_ServociosOtros(SucursalId, UsuarioId, EstacioN, "60", Detalles) Then
            'Obtener los Destinos
            Dim Dt_Destinos As DataTable = fn_AlertasGeneradas_ObtenerMails("60")
            If Dt_Destinos IsNot Nothing Then
                For Each renglon As DataRow In Dt_Destinos.Rows
                    If fn_ValidarMail(renglon("Mail")) Then Cn_Mail.fn_Enviar_MailHTML(renglon("Mail"), Cabezera, DetalleHTML, "")
                Next
            End If
        End If
    End Function
...
#Region "Servicios TV"
    ...
    Private Sub ServiciosTV_Limpiar()
        ...
        cmb_EsExtraodinario.SelectedValue = 0
    ...
    Private Sub ServiciosTV_ModoEdicion()
        ...
        cmb_EsExtraodinario.Enabled = True
    ...
    Private Sub ServiciosTV_ReadOnly()
        ...
        cmb_EsExtraodinario.Enabled = False
    ...
    Private Sub Btn_AgregarServicio_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_AgregarServicio.Click
        ...
        Dim EsExtraordinario As Char = cmb_EsExtraodinario.SelectedValue

        If cmb_Recoleccion.SelectedValue = "0" Then Recoleccion = "N"
        If cmb_EsExtraodinario.SelectedValue = "0" Then EsExtraordinario = "N"

        If lsv_ServiciosTV.SelectedItems.Count = 0 Then
            If Not fn_Servicios_Crear(Id_Cliente, dtp_FechaInicio.Value, tbx_ComentariosS.Text, cmb_Precio.SelectedValue, cmb_CuotaR.SelectedValue,
                                      0, cmb_KM.SelectedValue, CobroU, cmb_TVPredeterminado.SelectedValue, Recoleccion, EntregaD,
                                      CInt(Val(tbx_CantidadKM.Text)), cmb_Descripcion.SelectedValue, chk_Servicios.Checked,
                                      cmb_EsExtraodinario.SelectedValue,
                                      lsv_SubClientes) Then
                MsgBox("No se pudo Guardar el Registro.", MsgBoxStyle.Critical, frm_MENU.Text)
                Exit Sub
            End If
        Else
            If Not fn_Servicios_Actualizar(lsv_ServiciosTV.SelectedItems(0).Tag, dtp_FechaInicio.Value, tbx_ComentariosS.Text, cmb_Precio.SelectedValue,
                                           cmb_CuotaR.SelectedValue, 0, cmb_KM.SelectedValue, CobroU, cmb_TVPredeterminado.SelectedValue,
                                           Recoleccion, EntregaD,
                                           CInt(Val(tbx_CantidadKM.Text)),
                                           cmb_Descripcion.SelectedValue,
                                           chk_Servicios.Checked,
                                           lsv_SubClientes, cmb_EsExtraodinario.SelectedValue) Then
                MsgBox("No se pudo Actualizar el Registro.", MsgBoxStyle.Critical, frm_MENU.Text)
                Exit Sub
            End If
        End If
    ...
    Private Sub lsv_ServiciosTV_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles lsv_ServiciosTV.SelectedIndexChanged
        ...
        If lsv_ServiciosTV.SelectedItems.Count > 0 Then
            ...
            cmb_EsExtraodinario.Text = lsv_ServiciosTV.SelectedItems(0).SubItems(22).Text
...
#Region "Horarios"
    ...
    Private Sub lsv_H_Servicios_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lsv_H_Servicios.SelectedIndexChanged
        ...
        If lsv_H_Servicios.SelectedItems.Count > 0 Then
            ...
            Call fn_Horarios_LlenarListaActivos(lsv_H_Servicios.SelectedItems(0).Tag,
                                                IIf(chk_Horarios.Checked, True, False),
                                                lsv_HorariosActivos)
    ...
    Private Sub btn_EdicionGlobal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_EdicionGlobal.Click
        ...
        frm_MENU.prg_Barra.Maximum = 10 + Dt_HorariosTemporales.Rows.Count + Dt_HorariosReales.Rows.Count +
        ...
        With Wsht1
            ...
            .Range("E2").Comment.Text(Text:="Colores.-" & Chr(10) &
                                            "  - Sin Color: Registro para Editar." & Chr(10) &
                                            "  - Verde: Nuevo Horario." & Chr(10) &
            ...
            .Range("F2").Comment.Text(Text:="Colores:" & Chr(10) &
                                            "  - Sin Color: Registro no Editado." & Chr(10) &
            ...
            .Range("G2").Comment.Text(Text:="Colores:" & Chr(10) &
                                            "  - Naranja: Horario Pendiente." & Chr(10) &
                                            "  - Gris: Horario Real.")
            ...
            For Each HTemporales As DataRow In Dt_HorariosTemporales.Rows
                ...
                .Range("F" & Indicador).FormatConditions.Add(Type:=2, Formula1:=
                                                             "=O($G$" & Indicador & "<>$AG$" & Indicador & "," &
                                                             "$I$" & Indicador & "<>$AI$" & Indicador & "," &
                                                             "$J$" & Indicador & "<>$AJ$" & Indicador & "," &
                                                             "$K$" & Indicador & "<>$AK$" & Indicador & "," &
                                                             "$L$" & Indicador & "<>$AL$" & Indicador & "," &
                                                             "$M$" & Indicador & "<>$AM$" & Indicador & "," &
                                                             "$N$" & Indicador & "<>$AN$" & Indicador & "," &
                                                             "$O$" & Indicador & "<>$AO$" & Indicador & "," &
                                                             "$P$" & Indicador & "<>$AP$" & Indicador & "," &
                                                             "$Q$" & Indicador & "<>$AQ$" & Indicador & "," &
                                                             "$R$" & Indicador & "<>$AR$" & Indicador & "," &
                                                             "$S$" & Indicador & "<>$AS$" & Indicador & "," &
                                                             "$T$" & Indicador & "<>$AT$" & Indicador & "," &
            ...
            Try
                Dim Calendario_Excel = .OLEObjects.Add(ClassType:="MSCAL.Calendar.7", Link:=False,
                                                   DisplayAsIcon:=False, Left:=372, Top:=242.25, Width:=215.25, Height:=
                                                   143.25)
...
#Region "Imprimir"
    ...
    Private Sub btn_Servicios_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Id_Cliente > 0 Then
            ...
            If Ds.tbl_ServiciosOtros.Rows.Count = 0 AndAlso
            Ds.tbl_ServiciosTV.Rows.Count = 0 AndAlso
        ...
        Select Case sender.Name
            Case btn_PG.Name
                ...
                If chk_PN.Checked Then
                    ...
                    End If
                Else
                    Dim row As DataGridViewRow = dgv_Precios.CurrentRow
                    Dim Clave_precio As String = row.Cells(4).Value
                    Dim Descripcion = CStr(row.Cells(5).Value)
                    Dim Id_precio = CStr(row.Cells(6).Value)
                    Dim Precio_Anterior = CStr(row.Cells(7).Value)
                    ''Creamos un histrial de lo que va mnodificando el usuario.
                    If fn_Precios__Historial(dgv_Precios.Rows(dgv_Precios.SelectedCells(0).RowIndex).Cells("IdCSDataGridViewTextBoxColumn").Value, cmb_PS.SelectedValue, cmb_PDS.SelectedValue, Precio_Anterior, Clave_precio) Then
                        'MsgBox("Ocurrio un erro Historial, Contacta el administrador. ", MsgBoxStyle.Exclamation, frm_MENU.Text)
                        'Exit Sub
...
#End Region
    ...
    Private Sub rdb_CasetSI_CheckedChanged(sender As Object, e As EventArgs) Handles rdb_CasetSI.CheckedChanged
        gbx_CasetPropio.Enabled = rdb_CasetSI.Enabled
    End Sub

    Private Sub rdb_CasetNO_CheckedChanged(sender As Object, e As EventArgs) Handles rdb_CasetNO.CheckedChanged
        gbx_CasetPropio.Enabled = Not (rdb_CasetPropioNO.Checked)
        rdb_CasetPropioNO.Checked = rdb_CasetNO.Checked
    End Sub

    Private Sub tbx_LostFocus(sender As Object, e As EventArgs) Handles tbx_pp.LostFocus, tbx_pd.LostFocus, tbx_kmp.LostFocus, tbx_eep.LostFocus, tbx_crp.LostFocus

    End Sub

    Private Sub GroupBox2_Enter(sender As Object, e As EventArgs) Handles gbx_Remision.Enter

    End Sub

    Private Sub lbl_BajaPermanente_Click(sender As Object, e As EventArgs) Handles lbl_BajaPermanente.Click
    ...
    Private Sub tbx_NombreF_TextChanged(sender As Object, e As EventArgs) Handles tbx_NombreF.TextChanged
    ...
    ''' <summary>
    ''' En este codigo ponemos el cp corespondiente en el campo segun 
    ''' la colonia seleccionada y desactivamos los controles
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ...
    ''' <summary>
    ''' Con esta funcion validamos que no se permita guardar en el apartado de Servicios Otros y Servicios TV
    ''' </summary>
    ''' <returns></returns>
    Private Function ComprobarDatosContpaq() As Boolean

        Dim verificarDatos As DataRow = Fn_VerifcarDatosContpaq(Id_Cliente)

        Dim contpaqCodigo As String = verificarDatos("COMPAQ_Codigo").ToString()
        Dim contpaqDireccionCliente As String = verificarDatos("CONTPAQ_Direccion_Cliente").ToString()

        If contpaqCodigo = "" Or contpaqDireccionCliente = "" Then
            Return True
        Else
            Return False
        End If
    ...
    Private Sub rbn_UtilizaCatalogoDigitalSI_CheckedChanged(sender As Object, e As EventArgs) Handles rbn_UtilizaCatalogoDigitalSI.CheckedChanged

    End Sub

    Private Sub rdb_EnviarCorreoNo_Click(sender As Object, e As EventArgs) Handles rdb_EnviarCorreoNo.Click
    ...
    Private Sub Btn_AgregarColoniaFiscal_Click(sender As Object, e As EventArgs) Handles Btn_AgregarColoniaFiscal.Click
        If tbx_CPF.Text.Trim() <> "" Then
            frm_AgregarColonia.tbx_CodigoPostal.Text = tbx_CPF.Text
    ...
    Private Sub Btn_AgregarColoniaComercial_Click(sender As Object, e As EventArgs) Handles Btn_AgregarColoniaComercial.Click
        If tbx_CPC.Text.Trim() <> "" Then
            frm_AgregarColonia.tbx_CodigoPostal.Text = tbx_CPC.Text
            frm_AgregarColonia.ShowDialog()
        Else
            MsgBox("Favor de introducir el codigo postal", MsgBoxStyle.Critical, frm_MENU.Text)
        End If
