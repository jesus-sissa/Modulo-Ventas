    ...
    Private Sub Btn_Baja_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Baja.Click
        ...
        If Validar() Then
            ...
            If FRM.Firma = True Then
                ...
                If Not fn_ClientesBaja_Crear(cmb_Cliente.SelectedValue, cmb_Motivo.SelectedValue,
                                             tbx_Observaciones.Text.Trim, dtp_Fecha.Value.Date, tbx_Contacto.Text.Trim,
                                             tbx_Cargo.Text.Trim, tbx_ListaNegra.Text.Trim, cmb_Cliente.Text.Trim,
                                             Baja_Permanente, Dt_Clientes) Then
