Public Class frm_Kardex
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If tab_Nuevo.Text = "Nuevo" Then
            If Not Cn_Clientes.fn_Kardex_Caset_Insert(tbx_CodigoBarra.Text.Trim, tbx_Capacidad.Text, cmb_Cliente.SelectedValue, tbx_Serie.Text, cmb_Color.SelectedValue, If(rdb_Si.Checked, "S", "N"), If(rdb_RUTAINICIO_SI.Checked, "S", "N")) Then
    ...
    Function validar()
        ...
        If Not rdb_Si.Checked And Not rdb_No.Checked Then
            MsgBox("Indica si el caset es de Seguridad Interna.", MsgBoxStyle.Critical, frm_MENU.Text)
            Return False
        End If
        ...
        If rdb_No.Checked Then
            If Not rdb_RUTAINICIO_SI.Checked And Not rdb_RUTAINICIO_NO.Checked Then
                MsgBox("Selecciona si es una ruta de inicio.", MsgBoxStyle.Critical, frm_MENU.Text)
                Return False
            End If
        End If

        If cmb_Color.SelectedValue = "0" Then
            MsgBox("Seleccione un color, por favor.", MsgBoxStyle.Critical, frm_MENU.Text)
            Return False
        End If
    ...
    Private Sub BTN_Modificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTN_Modificar.Click
        ...
        '    rdb_Si.Checked = True
        '    rdb_RUTAINICIO_NO.Enabled = False
        '    rdb_Si.Enabled = False
        'Else
        '    rdb_RUTAINICIO_NO.Checked = True
        '    rdb_RUTAINICIO_NO.Enabled = False
        '    rdb_Si.Enabled = False
        'End If
    End Sub
    ...
    Private Sub rdb_Si_CheckedChanged(sender As Object, e As EventArgs) Handles rdb_Si.CheckedChanged
        rdb_RUTAINICIO_NO.Checked = (rdb_Si.Checked)
        gbx_RutaInicio.Enabled = Not (rdb_Si.Checked)
    End Sub
End Class