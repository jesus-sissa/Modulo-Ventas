...
Public Class frm_MENU
    ...
    '        End
    '    End If
    '    Cn_Login.fn_Log_Create("ABRIR VENTANA: REPORTE GENERAL DE SERVICIOS")

    '    Dim frm As New frm_ReporteGeneralServicios
    '    FuncionesGlobales.MostrarVentana(frm, True)
    'End Sub
    ...
    Private Sub ReporteDocumentosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReporteDocumentosToolStripMenuItem.Click
        SegundosDesconexion = 0
        If Not Cn_Login.fn_ValidaSesion(LoginId) Then
            End
        End If
        Cn_Login.fn_Log_Create("ABRIR VENTANA: REPORTE DOCUMENTOS")

        Dim frm As New frm_ReporteDocumentos
        FuncionesGlobales.MostrarVentana(frm, True)
    End Sub
    ...
    Private Sub ReporteGeneralServiciosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReporteGeneralServiciosToolStripMenuItem.Click
    ...
    Private Sub ReporteGeneralDeServiviosOtrosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReporteGeneralDeServiviosOtrosToolStripMenuItem.Click

        SegundosDesconexion = 0
        If Not Cn_Login.fn_ValidaSesion(LoginId) Then
            End
        End If
        Cn_Login.fn_Log_Create("ABRIR VENTANA: REPORTE GENERAL DE SERVICIOS OTROS")

        Dim frm As New frm_ReporteGeneralServiciosOtros
        FuncionesGlobales.MostrarVentana(frm, True)
    End Sub
    ...
    Private Sub ConsultaDeImportesPorRecoleccionToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ConsultaDeImportesPorRecoleccionToolStripMenuItem.Click
        ...
        If Not Cn_Login.fn_ValidaSesion(LoginId) Then
            End
        End If
        Cn_Login.fn_Log_Create("ABRIR VENTANA: CONSULTA DE IMPORTES POR RECOLECCION")

        Dim frm As New frm_ImportesPorRecoleecciones
        FuncionesGlobales.MostrarVentana(frm, True)
    End Sub

    Private Sub VentaDeMaterialesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles VentaDeMaterialesToolStripMenuItem.Click
        SegundosDesconexion = 0
        'Validar la Sesion
        If Not Cn_Login.fn_ValidaSesion(LoginId) Then
            End
        End If
        'Insertar en Usr_Log
        Cn_Login.fn_Log_Create("ABRIR VENTANA: CONSULTAR VENTA DE MATERIALES")

        Dim frm As New frm_VentasConsulta
        FuncionesGlobales.MostrarVentana(frm)
    End Sub

    Private Sub ClavesAVencerCajasFuertesToolStripMenuItem_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ReporteGeneralDeCajasFuertesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReporteGeneralDeCajasFuertesToolStripMenuItem.Click
        'Inicializar la variable de desconexion
        SegundosDesconexion = 0
        'Validar la Sesion
        If Not Cn_Login.fn_ValidaSesion(LoginId) Then
        ...
        End If
        'Insertar en Usr_Log
        Cn_Login.fn_Log_Create("ABRIR VENTANA: CLAVES A VENCES CAJAS FUERTES")

        Dim frm As New frm_CajasFuertesM
        FuncionesGlobales.MostrarVentana(frm)
    End Sub

    Private Sub RazonSocialDeClientesExternosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles RazonSocialDeClientesExternosToolStripMenuItem.Click
        SegundosDesconexion = 0
        If Not Cn_Login.fn_ValidaSesion(LoginId) Then
            End
        End If
        Dim frm As New Frm_RazonSocialExternos
        FuncionesGlobales.MostrarVentana(frm)
    End Sub
End Class
